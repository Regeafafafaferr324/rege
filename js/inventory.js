...
function inventorySetup(items, hotbarItems, weight, maxWeight) {
    ...
    if(((weight * 100) / maxWeight) > 100) {
        $("#playerInfo").html("<h3>INVENTORY</h3><p>" + round(weight) + "/" + maxWeight + " KG</p><div id='progbar'><div id='progbar-value' style='width: 100%'></div></div>");
    }else{
        $("#playerInfo").html("<h3>INVENTORY</h3><p>" + round(weight) + "/" + maxWeight + " KG</p><div id='progbar'><div id='progbar-value' style='width: " + (weight * 100) / maxWeight + "%'></div></div>");
    }       
    $("#playerInfo").show();
